...
class ParserTest extends PropSpec with PropertyChecks with Matchers with ScriptGen with NoShrink {
  ...
  property("simple expressions") {
    ...
    genElementCheck(BOOLgen(100))
    genElementCheck(SUMgen(100))
    genElementCheck(EQ_INTgen(100))
    genElementCheck(INTGen(100))
    genElementCheck(GEgen(100))
    genElementCheck(GTgen(100))
    genElementCheck(ANDgen(100))
    genElementCheck(ORgen(100))
  }
